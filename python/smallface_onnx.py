...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='models/smallface.onnx', help='ONNX model path')
    ...
    parser.add_argument('--json-output', type=str, default='output.json', help='path to save JSON output')
    ...
    for i, bbox in enumerate(bbox_coords):
        print("Raw Output from Python:", bbox)